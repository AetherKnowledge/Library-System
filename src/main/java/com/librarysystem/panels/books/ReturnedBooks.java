...
public class ReturnedBooks extends MyPanel {
    ...
    public void refreshItems(){
        returnedBooksList.removeAll();
        returnedBooksPanel = Utilities.makeReturnedBooksPanel();
