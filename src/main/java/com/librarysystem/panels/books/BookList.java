...
public class BookList extends MyPanel{
    ...
    public BookList() {
        ...
        Utilities.addChangePointer(sortBy);
        Utilities.addChangePointer(clearButton);
        
        bottomPanel.getVerticalScrollBar().setUnitIncrement(16);
    }
    
    public void addBooks(){
        ArrayList<BookPanel> bookPanels = Utilities.makeBookPanels();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Complete Books Records");
        add(jLabel13);
        jLabel13.setBounds(30, 10, 275, 29);
        ...
        jPanel12.setForeground(new java.awt.Color(145, 145, 145));
        ...
        jLabel10.setText("Books / book_list");
        add(jLabel10);
    ...
    public static boolean isKeepPopupVisible() {
        return keepPopupVisible;
    }

    public static void setKeepPopupVisible(boolean aKeepPopupVisible) {
        keepPopupVisible = aKeepPopupVisible;
    }
