...
public class JSpinField extends JPanel implements ChangeListener, CaretListener, ActionListener,
	...
	public JSpinField(int min, int max) {
		...
		darkGreen = CalendarColors.getTEXT_COLOR();
		...
		spinner.addChangeListener(this);
                textField.setBackground(CalendarColors.getHOVER_COLOR());
                textField.setForeground(CalendarColors.getTEXT_COLOR());
                ...
                spinner.setForeground(CalendarColors.getTEXT_COLOR());
                        ...
                        if (direction == SwingConstants.SOUTH) {
                            ...
                            b = new JButton(){
                                ...
                                public void paint(Graphics g){
                                    ...
                                    int[] xPoints = {getWidth() / 2, getWidth() / 2 - 5, getWidth() / 2 + 5};
                                    int[] yPoints = {getHeight() / 2 - 2, getHeight() / 2 + 3, getHeight() / 2 + 3};
